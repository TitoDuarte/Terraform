...
git clone https://github.com/TitoDuarte/PROY_MERN.git &&
cd PROY_MERN &&
cd client &&
...
cd .. &&
cd server &&
echo MONGO_URL="mongodb+srv://hduartea1:123@cluster0.ocwg15i.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"" > .env &&
